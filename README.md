...
**Exactus** is a specialized language model designed to generate precise, structured outputs with absolute zero hallucination. The project focuses on training, fine-tuning, and distilling models that prioritize factual accuracy, exact formatting, and efficient inference—particularly on CPU environments.
