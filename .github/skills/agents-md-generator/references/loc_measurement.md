...
Please install from https://github.com/XAMPPRocky/tokei and try again.
```
...
|-------|-----------|-----------------|
| Small | ≤ 10,000 | 10,000 characters |
| Small-Medium | 10,001 ~ 50,000 | 10,000 characters |
| Medium | 50,001 ~ 100,000 | 10,000 characters |
| Medium-Large | 100,001 ~ 500,000 | 15,000 characters |
| Large | 500,001 ~ 1,000,000 | 20,000 characters |
| Extra-Large | > 1,000,000 | 30,000 characters |
...
In this example: Total Lines = 50,000 → Small-Medium → 10,000 characters limit